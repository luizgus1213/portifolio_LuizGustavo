...
function abrirImagemAtual(nome) {
  ...
  const imagens = carousel.track.querySelectorAll("img");
  const imgAtual = imagens[carousel.slideAtual];
...
function abrirImagem(src, alt) {
  ...
  enviarEventoAnalytics("abrir_imagem", "Visualização de imagem", alt || src);
}
